...
router.get('/object1', function (req, res) {
  var objectGroups = [{ text: 'Группа 1', id: 1 }, { text: 'Группа 2', id: 2 }, { text: 'Группа 3', id: 3, parentId: 2 }];

  var objects = [{ id: 1, groupId: 1, text: 'объект 1' }, { id: 2, groupId: 2, text: 'объект 2' }, { id: 3, groupId: 2, text: 'объект 3' }];

  res.json({ objects: objects, objectGroups: objectGroups });
});

router.get('/object2', function (req, res) {
